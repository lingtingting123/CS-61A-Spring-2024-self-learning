...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {i:Button(i,lambda i:self.typed.append(i)) for i in LOWERCASE_LETTERS}  # Try a dictionary comprehension!
        # c: Button(c, self.typed.append)
...
class WinkingBear(Bear):
    ...
    def next_eye(self):
        "*** YOUR CODE HERE ***"
        self.turns += 1
        return Eye(True) if self.turns % 2 == 1 else Eye()
        # return Eye(self.eye_calls % 2) 奇偶对应True/False  
