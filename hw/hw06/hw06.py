...
class VendingMachine:
    ...
    def restock(self,amount):
        ...
        return f'Current {self.good} stock: {self.good_amount}'
    ...
    def vend(self):
        ...
        return f"Here is your {self.good} and ${dif} change."
...
def store_digits(n):
    ...
    #     return Link(n)
    # num = int(str(n)[0])
    # num_left = int(str(n)[1:])
    # return Link(num,store_digits(num_left))
    link = Link.empty
    while n > 0:
        digit = n % 10
        n //= 10
