...
def calc_eval(exp):
    ...
    3
    """
    print('DEBUG:','call calc_eval on ',exp)
...
def floor_div(args):
    ...
    """
    "*** YOUR CODE HERE ***"
    print('DEBUG:','call floor_div on ',args)
    # if args == nil:
    #     return 1
    # if args.rest == nil:
    #     return args.first
    # dividend = args.first // args.rest.first
    # divisor = args.rest.rest
    # return dividend // floor_div(divisor)
...
def eval_and(expressions):
    ...
    while expressions != nil:
        evaluate = calc_eval(expressions.first)
        if evaluate is scheme_f:
            return False
